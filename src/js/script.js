...
DJS.Statement = Class.create( DJS.Base, {
	...
	parse: function( source ) {
		...
		switch( token.value ) {
			...
			case "var":			this.specificStatement = new DJS.VariableDeclarationStatement( this );
								break;
								
			case "{":			this.specificStatement = new DJS.BlockStatement( this );
								break;
		
			case "if":			this.specificStatement = new DJS.IfStatement( this );
								break;
		
			case "while":		this.specificStatement = new DJS.WhileStatement( this );
								break;
		
			case "for":			this.specificStatement = new DJS.ForStatement( this );
								break;
		
			case "continue":	this.specificStatement = new DJS.ContinueStatement( this );
								break;
		
			case "break":		this.specificStatement = new DJS.BreakStatement( this );
								break;
		
			case "return":		this.specificStatement = new DJS.ReturnStatement( this );
								break;
		
			case "do":			this.specificStatement = new DJS.DoStatement( this );
								break;
		
			case "switch":		this.specificStatement = new DJS.SwitchStatement( this );
								break;
										
			default:			this.specificStatement = new DJS.ExpressionStatement( this );
								break;
		}
